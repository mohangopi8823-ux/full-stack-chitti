...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // For now, we'll use Manus OAuth login
      // In a production app, you would implement email/password authentication
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to your Chitti Naidu Pulao account</p>
            </div>
          ...
          <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
            <h3 className="font-semibold text-green-900 mb-2">Why create an account?</h3>
